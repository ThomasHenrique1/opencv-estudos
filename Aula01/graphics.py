...
# Version 5.0 (Unofficial) 10/18/2013 - James Futhey <james@jamesfuthey.com>
#     * Added checkKey() function to capture keyboard input
#
...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        master.bind("<Key>", self._onKeyPress) #JF
        self.height = height
        self.width = width
        self.autoflush = autoflush
        self._mouseCallback = None
        self._keyCallback=None #JF
        self.trans = None
        self.closed = False
        master.lift()
